...
export async function getTopMarkets(limit = 50): Promise<MarketRow[]> {
  try {
    ...
    console.error("getTopMarkets failed:", e);
    return [];
  }
}
...
export async function getTrendingMarkets(
  ...
  try {
    return await query<TrendingMarket>(
      `SELECT
        condition_id,
        question,
    ...
    console.error("getTrendingMarkets failed:", e);
    return [];
  }
}
...
export async function getCategoryBreakdown(): Promise<CategoryBreakdown[]> {
  try {
    return await query<CategoryBreakdown>(
      `SELECT
        category,
    ...
    console.error("getCategoryBreakdown failed:", e);
    return [];
  }
}
...
export async function getOrderBookImbalance(limit = 50): Promise<OBISignal[]> {
  try {
    ...
    console.error("getOrderBookImbalance failed:", e);
    return [];
  }
}
...
export async function getVolumeAnomalies(limit = 30): Promise<VolumeAnomaly[]> {
  try {
    return await query<VolumeAnomaly>(
      `SELECT
        t.condition_id,
        m.question,
    ...
    console.error("getVolumeAnomalies failed:", e);
    return [];
  }
}
...
export async function getLargeTrades(
  ...
  try {
    ...
    console.error("getLargeTrades failed:", e);
    return [];
  }
}
...
export async function getSignalsOverview(): Promise<SignalsOverview> {
  try {
    ...
    console.error("getSignalsOverview failed:", e);
    return {
      obi_signals: 0,
      volume_active_markets: 0,
      large_trades_24h: 0,
...
export async function getLeaderboard(
  ...
  try {
    return await query<TraderRanking>(
      `SELECT
        proxy_wallet,
        user_name,
        profile_image,
...
export async function getWhaleActivity(limit = 50): Promise<WhaleActivityFeed[]> {
  try {
    return await query<WhaleActivityFeed>(
      `SELECT
        wa.proxy_wallet,
        tp.pseudonym,
        tp.profile_image,
    ...
    console.error("getWhaleActivity failed:", e);
    return [];
  }
}
...
export async function getSmartMoneyPositions(limit = 50): Promise<SmartMoneyPosition[]> {
  try {
    return await query<SmartMoneyPosition>(
      `SELECT
        wp.proxy_wallet,
        tp.pseudonym,
        tp.profile_image,
    ...
    console.error("getSmartMoneyPositions failed:", e);
    return [];
  }
}
...
export async function getPositionConcentration(
  ...
  try {
    return await query<PositionConcentration>(
    ...
    console.error("getPositionConcentration failed:", e);
    return [];
  }
}
...
export async function getWhalesOverview(): Promise<WhalesOverview> {
  try {
    ...
    console.error("getWhalesOverview failed:", e);
    return {
      tracked_wallets: 0,
      whale_trades_24h: 0,
      total_whale_positions: 0,
...
export async function getArbitrageOpportunities(
  ...
  try {
    return await query<ArbitrageOpportunity>(
      `SELECT
        ao.condition_id,
        ao.event_slug,
        ao.arb_type,
    ...
    console.error("getArbitrageOpportunities failed:", e);
    return [];
  }
}
...
export async function getWalletClusters(
  ...
  try {
    return await query<WalletCluster>(
      `SELECT
        cluster_id,
        wallets,
        size,
    ...
    console.error("getWalletClusters failed:", e);
    return [];
  }
}
...
export async function getInsiderAlerts(
  ...
  try {
    return await query<InsiderAlert>(
      `SELECT
        ins.proxy_wallet,
        tp.pseudonym,
        tp.profile_image,
    ...
    console.error("getInsiderAlerts failed:", e);
    return [];
  }
}
...
export async function getCompositeSignals(
  ...
  try {
    return await query<CompositeSignal>(
      `SELECT
        cs.condition_id,
        m.question,
        cs.score,
    ...
    console.error("getCompositeSignals failed:", e);
    return [];
  }
}
...
export async function getAnalyticsOverview(): Promise<AnalyticsOverview> {
  try {
    ...
    console.error("getAnalyticsOverview failed:", e);
    return {
      open_arbitrages: 0,
      wallet_clusters: 0,
      insider_alerts: 0,
...
// --- Insider Trading Detection Queries ---
